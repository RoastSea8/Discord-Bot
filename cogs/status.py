...
class Status(commands.Cog):
    ...
    async def on_ready(self):
        ...
        self.status = ["american pageant course notes W", 'the group behind me during the quiz', f"{total_members} boys water polo team"] # ,help | @Kermit, f"on {len(self.bot.guilds)} servers"
